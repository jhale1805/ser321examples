      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          for (Object obj : jsonarr) {
            ...
            builder.append("<p> Repo Name: " + jsonobj.get("full_name"));
            builder.append("<ul> <li> ID: " + jsonobj.get("id"));
            builder.append("<li> Owner: " + jsonobj.getJSONObject("owner").get("login") + "</ul>");
          }
